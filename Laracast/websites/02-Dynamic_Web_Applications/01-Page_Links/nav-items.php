            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/Laracast/websites/02-Dynamic_Web_Applications/01-Page_Links" aria-current="page" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Home</a>
                        ...
                        <a href="/Laracast/websites/02-Dynamic_Web_Applications/01-Page_Links/contact.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Conact</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
